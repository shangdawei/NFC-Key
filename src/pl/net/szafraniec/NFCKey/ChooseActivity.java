...
public class ChooseActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (NFCKEYSettings.Default_APP == 0) {rb0.setChecked(true);}
	    if (NFCKEYSettings.Default_APP == 1) {rb1.setChecked(true);}
	    if (NFCKEYSettings.Default_APP == 2) {rb2.setChecked(true);}
	    if (NFCKEYSettings.Default_APP == 3) {rb3.setChecked(true);}
